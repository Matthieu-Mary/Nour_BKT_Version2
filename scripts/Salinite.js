...
function cleanSaliniteData(data) {
  ...
  uploadForm.addEventListener("submit", (event) => {
    ...
    reader.onload = () => {
      ...
      const cleanedData = cleanSaliniteData(data); // Appliquer la fonction de nettoyage
      ...
      link.download = "cleaned_salinite.json";
